...
class Hostel(models.Model):
    ...
    def _referencable_models(self):
        # 1. Cari Model di seluruh sistem ('ir.model')
        # 2. Syaratnya: Model tersebut harus punya field bernama 'message_ids'
        models = self.env['ir.model'].search([
            ('field_id.name', '=', 'message_ids')])
        
        # 3. Kembalikan daftar nama model yang lolos seleksi
